      ...
      (() => {
          ...
          render() {
            ...
            return n.createElement(
              ...
              n.createElement(
                r,
                null,
                n.createElement(i, null, n.createElement(s, null))
              )
            );
          }
        }
        ...
        class TopBar extends n.Component {
          ...
          render() {
            ...
            if (c) {
              ...
              c.forEach((t, r) => {
                e.push(
                  n.createElement('option', { key: r, value: t.url }, t.name)
                );
              }),
                f.push(
                  n.createElement(
        ...
        var _e = new ie('tag:yaml.org,2002:float', {
            ...
            represent: function representYamlFloat(e, t) {
              ...
              return (
                (r = e.toString(10)), de.test(r) ? r.replace('e', '.e') : r
              );
            },
            defaultStyle: 'lowercase',
          }),
        ...
        var Oe = new ie('tag:yaml.org,2002:omap', {
            ...
            resolve: function resolveYamlOmap(e) {
              ...
              for (t = 0, r = s.length; t < r; t += 1) {
                if (((n = s[t]), (o = !1), '[object Object]' !== Ee.call(n)))
                  return !1;
                for (i in n)
                  if (xe.call(n, i)) {
                    if (o) return !1;
        ...
        for (
          var Ve = new Array(256), $e = new Array(256), He = 0;
          He < 256;
          He++
        )
                    ...
                    for (
                      ...
                      d
                        ...
                        c
                          ...
                          : s
                          ? o.push(
                              storeMappingPair(e, null, m, l, f, h, r, n, i)
                            )
                          : o.push(f),
                        skipSeparationSpace(e, !0, t),
        ...
        function indentString(e, t) {
          for (
            var r, n = J.repeat(' ', t), i = 0, o = -1, a = '', s = e.length;
            i < s;
        ...
        const Wt = ErrorBoundary,
          Kt = [
            ...
            function configsPlugin() {
              return {
                statePlugins: {
                  configs: { reducers: Rt, actions: e, selectors: t },
                },
              };
            },
            stadalone_layout,
